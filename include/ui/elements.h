...
struct Element {
 public:
  ...
  virtual void Render(const std::shared_ptr<Shader> text_shader,
                      const std::shared_ptr<Shader> rect_shader) = 0;
...
struct Button : Element {
 ...
 private:
  ...
  std::function<void()> on_click;
  glm::vec4 background_color{0.0f, 0.0f, 0.0f, 0.7f};
  glm::vec4 hover_color{0.3f, 0.3f, 0.3f, 0.7f};
